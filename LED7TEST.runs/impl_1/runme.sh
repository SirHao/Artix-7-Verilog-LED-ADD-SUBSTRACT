...
HD_PWD='G:/vivadoWorkSpace/LED7TEST/LED7TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED7TEST.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED7TEST.tcl -notrace
