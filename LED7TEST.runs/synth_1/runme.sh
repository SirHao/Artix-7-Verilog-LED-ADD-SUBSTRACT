...
HD_PWD='G:/vivadoWorkSpace/LED7TEST/LED7TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED7TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED7TEST.tcl
